...
Download the [executable from github](https://github.com/snowplow-incubator/snowplow-event-generator/releases/download/0.10.0/snowplow-event-generator-0.10.0.tar.gz). You need java installed to run it.

```bash
wget https://github.com/snowplow-incubator/snowplow-event-generator/releases/download/0.10.0/snowplow-event-generator-0.10.0.tar.gz
tar -xzf snowplow-event-generator-0.10.0.tar.gz
```
...
```
libraryDependencies += "com.snowplowanalytics" % "snowplow-event-generator-core" % "0.10.0" % Test
```
