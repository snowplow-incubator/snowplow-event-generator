...
Download the [executable from github](https://github.com/snowplow-incubator/snowplow-event-generator/releases/download/0.2.0/snowplow-event-generator-0.2.0.zip). You need java installed to run it.

```bash
wget https://github.com/snowplow-incubator/snowplow-event-generator/releases/download/0.2.0/snowplow-event-generator-0.2.0.zip
...
```
{
    ...
    // All event timestamps are close in time to this value.  Change this to generate more recent or more historic events.
    "now": "2022-02-01T01:01:01z"
}
```
