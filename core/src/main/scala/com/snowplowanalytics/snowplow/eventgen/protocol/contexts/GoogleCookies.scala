...
object GoogleCookies extends SelfDescribingJsonGen {
  ...
  override def fieldGens(now: Instant): Map[String, Gen[Option[Json]]] =
    Map(
      "__utma" -> strGen(1, 12).optional,
      "__utmb" -> strGen(1, 12).optional,
      "__utmc" -> strGen(1, 12).optional,
      "__utmv" -> strGen(1, 12).optional,
      "__utmz" -> strGen(1, 12).optional,
      "_ga"    -> strGen(1, 12).optional
    )
}
