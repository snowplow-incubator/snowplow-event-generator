...
object BufferStartEvent extends SelfDescribingJsonGen {

  override def schemaKey: SchemaKey =
    SchemaKey("com.snowplowanalytics.snowplow.media", "buffer_start_event", "jsonschema", SchemaVer.Full(1, 0, 0))
