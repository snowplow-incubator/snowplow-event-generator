...
object PercentProgressEvent extends SelfDescribingJsonGen {

  override def schemaKey: SchemaKey =
    SchemaKey("com.snowplowanalytics.snowplow.media", "percent_progress_event", "jsonschema", SchemaVer.Full(1, 0, 0))
